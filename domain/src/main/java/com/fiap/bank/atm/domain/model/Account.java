...
public class Account extends BaseEntity {
    ...
    public Account(UUID id, String accountNumber, String pin, Money initialBalance,
                   Money dailyWithdrawalLimit, Money totalWithdrawnToday,
                   boolean blocked, int failedAttempts) {
        this(id, accountNumber, pin, initialBalance, dailyWithdrawalLimit);
